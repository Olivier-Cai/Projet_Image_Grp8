...
public class Main {
	/**
	 * methode ne marche que si le seuil est de type >= et l'image en noir et blanc. il retourne boolean si le seuil le dépasse 
	 * @param depassed
	 * @param seuilactuel
	 * @param seuil
	 * @return boolean
	...
	/**
	 * trace le graphique sur les pixels noir en fonction de l'image sur l'axe X et Y et affiche ces graphiques
	 * @param img
	 * @throws IOException
	 */
